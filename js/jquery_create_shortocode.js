var create_shortcode_string = {
   ...
   createString3:function(obj){
	   ...
	   else
	   {
		...
		create_shortcode_string.str_sort_by = "sort_by_values='post_title'";
	   }
	   create_shortcode_string.appendStr();
   },
   ...
   appendStr:function(){
	   create_shortcode_string.main_string=create_shortcode_string.start_string +" "+ create_shortcode_string.str_title +" "+" "+create_shortcode_string.str_sort_by+" "+create_shortcode_string.str_exclude_page+" "+create_shortcode_string.str_depth_level+" "+create_shortcode_string.str_sort_order_parent+" "+create_shortcode_string.end_string;
	   
	   var shortcodeHTML = '<code>' + create_shortcode_string.main_string + '</code>';
	   jQuery("#shortcode").html(shortcodeHTML);
